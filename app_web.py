...
if st.session_state.teacher_weekly_data is None:
    ...
    with tab1:
        ...
        with st.form("teacher_form"):
            ...
            for w in weeks_info:
                ...
                edited_df = st.data_editor(original_df, column_config=column_config, use_container_width=True, key=f"teacher_edit_{label}", height=300)
    ...
    with tab2:
        ...
        with st.form("req_form"):
            edited_req_df = st.data_editor(st.session_state.student_req_df, hide_index=True, use_container_width=True)
        ...
        if target_student:
            ...
            with st.form(f"student_form_{target_student}"):
                ...
                for w in weeks_info:
                    ...
                    edited_s_df = st.data_editor(s_df, column_config=column_config_s, use_container_width=True, key=f"student_edit_{target_student}_{label}", height=300)
